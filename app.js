...
const DATA = {
  en:{
    ...
    courses:["General English 1 (GE2)","Reading & Writing","Listening & Speaking","Integrated Grammar & Lexis","Oral Presentations"],
    timeline:[
    ...
    ge2_eyebrow:"Course guide", ge2_h:"General English 2", ge2_p:"Everything about the GE2 course — objectives, outcomes, assessment, weekly plan, attendance and exam rules — in one page.",
    ge2_tag:"📘 GE2", ge2_title:"General English 2 (FPGE0002)", ge2_cta:"Open the course guide ↗",
    utas_eyebrow:"Official site", utas_h:"UTAS – Nizwa", utas_p:"Visit the official University of Technology and Applied Sciences – Nizwa website for admissions, news and more.",
    utas_cta:"Visit utas.edu.om/nizwa ↗",
    activities:[
    ...
    uniInfo:[
      ...
      {i:"📗",t:"Course: GE2",d:"General English 1 (FPGE0001): Reading & Writing (10 hrs/week) and Listening & Speaking (8 hrs/week)."},
    ...
    faq:[
      {q:"How do I pass GE2?",a:"Score at least 50 in the cumulative mark (CA + Final) and at least 50 in the Final Exam."},
      {q:"How is GE2 graded?",a:"Continuous Assessment is 50% (Midterm 30% + oral presentations and e-learning 20%); the Final Exam is 50%."},
    ...
    footer:"Built for foundation students who learn by doing. © 2026 Faisal's Portfolio. Done by Zamzam Issa.",
  ...
  ar:{
    ...
    courses:["الإنجليزية العامة ١ (GE2)","القراءة والكتابة","الاستماع والتحدّث","القواعد والمفردات المدمجة","العروض الشفهية"],
    timeline:[
    ...
    ge2_eyebrow:"دليل المقرر", ge2_h:"اللغة الإنجليزية العامة 2", ge2_p:"كل شي عن مقرر اللغة الإنجليزية العامة 2 — الأهداف، مخرجات التعلم، التقييم، الخطة الأسبوعية، الحضور وقوانين الامتحان — بصفحة وحدة.",
    ge2_tag:"📘 اللغة الإنجليزية 2", ge2_title:"اللغة الإنجليزية العامة 2 (رمز المادة FPGE0002)", ge2_cta:"افتحي دليل المقرر ↗",
    utas_eyebrow:"الموقع الرسمي", utas_h:"جامعة التقنية والعلوم التطبيقية – نزوى", utas_p:"زوري الموقع الرسمي لجامعة التقنية والعلوم التطبيقية بنزوى للقبول والأخبار والمزيد.",
    utas_cta:"زيارة الموقع الرسمي ↗",
    activities:[
    ...
    uniInfo:[
      ...
      {i:"📗",t:"المقرر: GE2",d:"الإنجليزية العامة ١ (FPGE0001): القراءة والكتابة (١٠ ساعات/أسبوع) والاستماع والتحدّث (٨ ساعات/أسبوع)."},
    ...
    faq:[
      {q:"كيف أنجح في GE2؟",a:"احصل على ٥٠ على الأقل في الدرجة التراكمية (التقييم المستمر + النهائي) و٥٠ على الأقل في الاختبار النهائي."},
      {q:"كيف يُقيَّم GE2؟",a:"التقييم المستمر ٥٠٪ (نصفي ٣٠٪ + عروض شفهية وأنشطة إلكترونية ٢٠٪)، والاختبار النهائي ٥٠٪."},
    ...
    footer:"صُمّم لطلاب التأسيس الذين يتعلّمون بالممارسة. © ٢٠٢٦ بورتفوليو فيصل. تصميم زمزم عيسى.",
...
function tickStars(){ sctx.clearRect(0,0,stars.width,stars.height);
  ...
  sctx.fillStyle=dark?"rgba(214,90,49,.55)":"rgba(214,90,49,.5)";
  ...
  for(let i=0;i<pts.length;i++)for(let j=i+1;j<pts.length;j++){ const dx=pts[i].x-pts[j].x,dy=pts[i].y-pts[j].y,d=dx*dx+dy*dy;
    if(d<10000){ sctx.strokeStyle=(dark?"rgba(214,90,49,":"rgba(214,90,49,")+(1-d/10000)*.25+")"; sctx.lineWidth=.6;
